	...
	<body class="homepage is-preload">
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<a href="./carrinho.html"><button type="button" class="btn btn-primary">Carrinho</button></a>
												...
												<section class="box">
													...
													<footer>
														...
														<form action="./produto.php" method="POST">
																<input type="hidden" name="identificador" value="prod01" />
											...
											<div class="col-4 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./produto.php" method="POST">
																<input type="hidden" name="identificador" value="prod02" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-4 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./produto.php" method="POST">
																<input type="hidden" name="identificador" value="prod03" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-4 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
															<form action="./produto.php" method="POST">
																<input type="hidden" name="identificador" value="prod04" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-4 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./produto.php" method="POST">
																<input type="hidden" name="identificador" value="prod05" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-4 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./produto.php" method="POST">
																<input type="hidden" name="identificador" value="prod06" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
