				...
				<section id="header">
					...
					<!-- Banner -->
						<section id="banner">
							<header>
								<?php
                                    echo '<h2>Seja Bem Vindo '.$_SESSION['nomeUsuario'].' !</h2>';
                                ?>
											...
											<div class="col-3 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./mostraProduto.php" method="POST">
																<input type="hidden" name="identificador" value="21" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-3 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./mostraProduto.php" method="POST">
																<input type="hidden" name="identificador" value="24" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-3 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./mostraProduto.php" method="POST">
																<input type="hidden" name="identificador" value="25" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-3 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./mostraProduto.php" method="POST">
																<input type="hidden" name="identificador" value="31" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-3 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./mostraProduto.php" method="POST">
																<input type="hidden" name="identificador" value="33" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
											...
											<div class="col-3 col-6-medium col-12-small">
												<section class="box">
													...
													<footer>
														<ul class="actions">
														<form action="./mostraProduto.php" method="POST">
																<input type="hidden" name="identificador" value="35" />
																<button>Comprar</button>
														    </form>
														</ul>
													</footer>
