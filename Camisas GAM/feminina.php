					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li  class="current"><a href="feminina.php">Feminina</a></li>
								<li><a href="masculina.php">Masculina</a></li>
										...
										<div class="col-4 col-6-medium col-12-small">
											<section class="box">
												...
												<footer>
													<ul class="actions">
													<form action="./produto.php" method="POST">
															<input type="hidden" name="identificador" value="29" />
															<button>Comprar</button>
													    </form>
													</ul>
												</footer>
